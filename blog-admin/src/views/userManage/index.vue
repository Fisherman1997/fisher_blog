        ...
        <div class="user-content">
            <el-table
                ...
                <el-table-column prop="name" label="名称">
                    <template #default="props">
                        <el-space>
                            ...
                            <el-tag v-if="props.row.status === 1" class="ml-2" type="success">启用</el-tag>
                ...
                <el-table-column label="操作"  align="center">
                    <template #default="props">
                        <el-button type="primary" @click="changeUser('update',props.row)" link >信息</el-button>
                        <el-button type="primary" @click="changePower(props.row)"  link >权限</el-button>
                        <el-button type="primary" @click="changePasswordFun(props.row)"  link >修改密码</el-button>
...
import InsertAndUpdateUser from './modula/InsertAndUpdateUser'
import ChangePassword from './modula/ChangePassword'
import PowerModula from './modula/PowerModula'
...
const changeUser = (type = 'insert', row = {}) => {
    customDialog({
