    ...
    <div id="login-and-register">
        <div class="conetent">
            ...
            <div class="headline" :class="[animatLoginLeft]">
                ...
                <div @click="routePush" class="change-router">
        ...
        <div
            ...
            :class="{
                'blue-background-left': route.path === '/admin/login',
                'blue-background-right': route.path === '/admin/register',
            }"
        ></div>
...
import { useSetAnimation } from './hooks/useSetAnimation.ts'
...
// 动画效果
const { animatLoginLeft, animatloginRight, colorball1, colorball2, colorball3, changeCss } =
    useSetAnimation()
