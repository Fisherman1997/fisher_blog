        ...
        <div class="random-content">
            <el-table
                ...
                <el-table-column label="操作" width="180px"  align="center">
                    <template #default="props">
                        <el-button type="primary" @click="changeRandom('update',props.row)" link >修改</el-button>
...
import RandomChangeModula from './modula/RandomChangeModula'
...
const changeRandom = (type = 'insert', row = {}) => {
    customDialog({
