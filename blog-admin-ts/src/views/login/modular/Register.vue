    ...
    <div class="register">
        <div class="form-css">
            ...
            >
                ...
                <el-button @click="submitForm(registerForm)" type="primary" size="large"
                    >注册</el-button
                >
            </el-form>
        </div>
...
const model = reactive<IRegister>({
    name: '',
    code: '',
    Email: '',
    password: '',
...
const rules = {
    ...
    Email: [{ required: true, message: '请输入密码！！！', trigger: 'change' }],
...
const submitForm = (formModul: typeof registerForm.value) => {
    // 提交登录表单
    if (!formModul) return
