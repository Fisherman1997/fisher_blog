<template>
	<div id="routing-manage">
        <div class="routing-manage-hrader">
            ...
            <el-button @click="changeRoute('insert')" type="primary"><el-icon><Plus /></el-icon> 新增</el-button>
        </div>
        <el-table 
                        ...
                        <el-table :data="props.row.children" :border="true">
                            ...
                            <el-table-column label="标题" prop="title">
                                <template #default="props">
                                    <el-space>
                                        {{ props.row.title }}
                                        <el-tag v-if="props.row.range === 1" class="ml-2" type="warning">前台</el-tag>
                                        <el-tag v-if="props.row.range === 0" class="ml-2" type="warning">后台</el-tag>
                                        <el-tag v-if="props.row.menu === 1" class="ml-2" type="success">菜单</el-tag>
                                        <el-tag v-if="props.row.menu === 0" class="ml-2" type="success">非菜单</el-tag>
                                    </el-space>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column label="操作">
                                <template #default="props">
                                    <el-button type="primary" @click="changeRoute('update',props.row)" link >修改</el-button>
...
import InsetAndUpdateRoute from './modula/InsetAndUpdateRoute'
...
const changeRoute = (type = 'insert', row) => {
