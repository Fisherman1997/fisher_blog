            ...
            <el-table :border="true" :data="tableObject.tableList">
                ...
                <el-table-column prop="content" label="内容">
                    <template #default="props">
                        <el-text truncated>{{ props.row.content }}</el-text>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template #default="props">
                        <el-button type="primary" @click="changeComment(props.row)" link
                            >修改</el-button
                        >
                        <el-popconfirm
                            title="确认删除吗？"
...
const { tableObject, methods } = useTable<IComment, FromParam>({
    url: {
        find: 'comment/list',
